...
/**
*
* jcrdsoapclient higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $jcrdsoapclient = new jcrdsoapclient( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $jcrdsoapclient->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($jcrdsoapclient);
*
* @author   Dietrich Ayala <dietrich@ganx4.com>
* @version  $Id: class.jcrdsoapclient.php,v 1.52 2005/07/27 19:24:42 snichol Exp $
* @access   public
*/
class jcrdsoapclient extends nusoap_base  {
	...
	* @access   public
	*/
	function jcrdsoapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends jcrdsoapclient {
	'.$evalStr.'
}';
		return $evalStr;
	}
