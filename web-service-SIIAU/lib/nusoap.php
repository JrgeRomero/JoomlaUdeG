 ...
 * $soapclient = new wdgsiiauNEW_client( string path [ ,mixed wsdl] );
 *
 ...
 * @access   public
 */
class wdgsiiauNEW_client extends nusoap_base
{
	...
	";
        ...
        $evalStr = 'class nusoap_proxy_' . $r . ' extends wdgsiiauNEW_client {
	' . $evalStr . '
}';
        return $evalStr;
    }
...
if (!extension_loaded('soap')) {
     ...
     */
    class soapclient extends wdgsiiauNEW_client
    {
    }
}
