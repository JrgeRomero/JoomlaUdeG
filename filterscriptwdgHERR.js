...
      	}
		...
		if(window.location.href.endsWith("herramientas/hv")){
			jQuery(".sprocket-lists-portrait-title").attr("style","font-size: 24px !important");
			jQuery(".sprocket-lists-portrait-item").attr("style","margin-left: 4% !important");
		}
