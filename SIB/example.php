...
<td>
  ...
  <td><input type="text" name="graphValues" size="30" maxlength="200" value="<?php echo $graphValues; ?>"></td>
  </tr><tr>
  <td align="right">Labels (comma-separated):</td>
  <td><input type="text" name="graphLabels" size="30" maxlength="200" value="<?php echo $graphLabels; ?>"></td>
  </tr><tr>
  <td align="right">Bar Width:</td>
  <td><input type="text" name="graphBarWidth" size="3" maxlength="3" value="<?php echo $graphBarWidth; ?>"></td>
  </tr><tr>
  <td align="right">Label Font Size:</td>
  <td><input type="text" name="graphLabelSize" size="2" maxlength="2" value="<?php echo $graphLabelSize; ?>"></td>
  </tr><tr>
  <td align="right">Values Font Size:</td>
  <td><input type="text" name="graphValuesSize" size="2" maxlength="2" value="<?php echo $graphValuesSize; ?>"></td>
  </tr><tr>
  <td align="right">Percentage Font Size:</td>
  <td><input type="text" name="graphPercSize" size="2" maxlength="2" value="<?php echo $graphPercSize; ?>"></td>
  </tr></table>
</td>
<td>
  <table border="0"><tr>
  <td align="right">Graph BG Color:</td>
  <td><input type="text" name="graphBGColor" size="12" maxlength="12" value="<?php echo $graphBGColor; ?>"></td>
  </tr><tr>
  <td align="right">Bars Color:</td>
  <td><input type="text" name="graphBarColor" size="12" maxlength="12" value="<?php echo $graphBarColor; ?>"></td>
  </tr><tr>
  <td align="right">Bars BG Color:</td>
  <td><input type="text" name="graphBarBGColor" size="12" maxlength="12" value="<?php echo $graphBarBGColor; ?>"></td>
  </tr><tr>
  <td align="right">Labels Color:</td>
  <td><input type="text" name="graphLabelColor" size="12" maxlength="12" value="<?php echo $graphLabelColor; ?>"></td>
  </tr><tr>
  <td align="right">Labels BG Color:</td>
  <td><input type="text" name="graphLabelBGColor" size="12" maxlength="12" value="<?php echo $graphLabelBGColor; ?>"></td>
  </tr><tr>
  <td align="right">Values Color:</td>
  <td><input type="text" name="graphValuesColor" size="12" maxlength="12" value="<?php echo $graphValuesColor; ?>"></td>
  </tr><tr>
  <td align="right">Values BG Color:</td>
  <td><input type="text" name="graphValuesBGColor" size="12" maxlength="12" value="<?php echo $graphValuesBGColor; ?>"></td>
  </tr></table>
</td>
</tr><tr>
